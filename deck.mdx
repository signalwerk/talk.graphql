...
<Head>
  ...
  <link href="https://cdn.jsdelivr.net/gh/signalwerk/talk.graphql@master/styles.css" rel="stylesheet" />
</Head>
...
* Clone and Setup [gitlab.liip.ch/bazinga/shkb.next](https://gitlab.liip.ch/bazinga/shkb.next)
...
* Clone of [shkb.ch/179-kbplus-paket](https://www.shkb.ch/179-kbplus-paket)
...
* Pick a task → see also [Wiki](https://wiki.liip.ch/pages/viewpage.action?pageId=622993617)
